  ...
  render() {
    return (
      <div className="single-story">
        ...
        <p className="single-story-description">
          {this.state.storyDescription && this.state.storyDescription}
        </p>
          ...
          <div className="single-story-scenes">
            {this.state.scenes.map(scene => (
              <div key={scene.data().id}>
                <img
                  className="single-story-scenes-scene"
        ...
        <a
          className="single-story-add-link"
          href={`/stories/${this.props.match.params.id}/addscene`}
        >
          <div className="single-story-add">+ Add Scene</div>
        </a>
        <a
          className="single-story-add-link"
          href={`/stories/${this.props.match.params.id}/collaborate`}
        >
